...
const Header = ({ isShowing }) => {
  return (
    <>
      ...
      <div className='fixed w-[calc(100%-24px)] left-0 right-0 mx-auto my-[8px] py-[8px] px-[12px] z-10 top-0 flex flex-row items-center justify-between rounded-[72px] border-[1px] border-opacity-0'>
        <div className='h-[44px] w-[44px] opacity-0' />
        <Button />
      </div>
    </>
  );
